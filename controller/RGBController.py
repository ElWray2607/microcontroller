...
class RGBController:
    ...
    async def on_light_state_change(self, topic, payload):
    ...
    async def on_light_brightness_change(self, topic, payload):
    ...
    async def on_light_rgb_change(self, topic, payload):
